...
public class GohanCountDown
{
    ...
    private void $$$setupUI$$$()
    {
        ...
        label7.setText("秒");
        panel1.add(label7, cc.xy(13, 23));
        final JSeparator separator1 = new JSeparator();
        panel1.add(separator1, cc.xyw(3, 20, 11, CellConstraints.FILL, CellConstraints.FILL));
        ...
        panel1.add(label_nowtime, cc.xyw(3, 13, 11));
        ...
        panel1.add(spacer3, cc.xy(5, 29, CellConstraints.DEFAULT, CellConstraints.FILL));
        final JLabel label13 = new JLabel();
        label13.setHorizontalAlignment(4);
        label13.setHorizontalTextPosition(10);
        label13.setText("誤差");
        panel1.add(label13, cc.xy(3, 8));
        label_errortime = new JLabel();
        label_errortime.setText("");
        panel1.add(label_errortime, cc.xyw(5, 8, 9));
    }
